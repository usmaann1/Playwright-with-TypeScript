...
test.describe('TestSuite: Create Teams', () => {
    ...
    test('TC - Import Course CS Awesome From Import Coding Rooms Courses Button', async ({ createTeams }) => {
    ...
    test('TC - Import Course CS Awesome From New Teams Import Courses Button', async ({ createTeams }) => {
        await PlaywrightCore.click(createTeams.CreateNewTeamBtn)
    ...
    test('TC - Import Replit Team From Teams/Courses Page', async ({ createTeams }) => {
    ...
    test('TC - Import Replit Team From Create Team Pop Up Page', async ({ createTeams }) => {
        await PlaywrightCore.click(createTeams.CreateNewTeamBtn)
