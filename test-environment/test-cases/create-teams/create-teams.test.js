...
test.describe('TestSuite: Create Teams', () => {
    ...
    test('TC - Import Course CS Awesome From Team/Courses Page', async ({ createTeams }) => {
        ...
        PlaywrightCore.fileUpload(createTeams.UploadZip, CreateTeamsTestData.CSAwesomeCourseZipPath)
        ...
        await expect(createTeams.UnzippingAndValidinag).toHaveText(CreateTeamsTestData.UnzippingAndValidinagValue)
