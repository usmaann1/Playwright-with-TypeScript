...
static async allTextContents(locator) {
    try {
        ...
        console.warn(`An error occurred while fetching text contents of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async check(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking ${locator}, Error:`, error);
        throw error;
    }
}
...
static async clear(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while clearing ${locator}, Error:`, error);
        throw error;
    }
}
...
static async click(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while clicking ${locator}, Error:`, error);
        throw error;
    }
}
...
static async count(locator) {
    try {
        ...
        console.warn(`An error occurred while counting elements of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async doubleClick(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while double-clicking ${locator}, Error:`, error);
        throw error;
    }
}
...
static async dragAndDrop(sourceLocator, targetLocator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while dragging from ${sourceLocator} to ${targetLocator}, Error:`, error);
        throw error;
    }
}
...
static async fill(locator, textToFill, options = {}) {
    try {
        ...
        console.warn(`An error occurred while filling ${locator} with text, Error:`, error);
        throw error;
    }
}
...
static async filter(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while filtering ${locator}, Error:`, error);
        throw error;
    }
}
...
static async first(locator) {
    try {
        ...
        console.warn(`An error occurred while fetching the first element of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async focus(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while focusing on ${locator}, Error:`, error);
        throw error;
    }
}
...
static async goTo(page, url, options = {}) {
    try {
        ...
        console.warn(`An error occurred while navigating to ${url}, Error:`, error);
        throw error;
    }
}
...
static async getAttribute(locator, attributeName, options = {}) {
    try {
        ...
        console.warn(`An error occurred while getting attribute ${attributeName} of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async hover(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while hovering over ${locator}, Error:`, error);
        throw error;
    }
}
...
static async innerHTML(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while getting innerHTML of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async innerText(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while getting innerText of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async inputValue(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while getting input value of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async isChecked(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is checked, Error:`, error);
        throw error;
    }
}
...
static async isDisabled(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is disabled, Error:`, error);
        throw error;
    }
}
...
static async isEditable(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is editable, Error:`, error);
        throw error;
    }
}
...
static async isEnabled(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is enabled, Error:`, error);
        throw error;
    }
}
...
static async isHidden(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is hidden, Error:`, error);
        throw error;
    }
}
...
static async isVisible(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while checking if ${locator} is visible, Error:`, error);
        throw error;
    }
}
...
static async locator(locator, selector, options = {}) {
    try {
        ...
        console.warn(`An error occurred while creating locator for ${selector} in ${locator}, Error:`, error);
        throw error;
    }
}
...
static async press(locator, textTopress, options = {}) {
    try {
        ...
        console.warn(`An error occurred while pressing ${textTopress} on ${locator}, Error:`, error);
        throw error;
    }
}
...
static async scrollIntoViewIfNeeded(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while scrolling into view for ${locator}, Error:`, error);
        throw error;
    }
}
...
static async selectDropDownOption(locator, optionToSelect, options = {}) {
    try {
        ...
        console.warn(`An error occurred while selecting option ${optionToSelect} in ${locator}, Error:`, error);
        throw error;
    }
}
...
static async setCheckBox(locator, toCheck, options = {}) {
    try {
        ...
        console.warn(`An error occurred while setting checkbox for ${locator}, Error:`, error);
        throw error;
    }
}
...
static async setRadioBtn(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while setting radio button for ${locator}, Error:`, error);
        throw error;
    }
}
...
static async textContent(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while fetching text content of ${locator}, Error:`, error);
        throw error;
    }
}
...
static async uncheck(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while unchecking ${locator}, Error:`, error);
        throw error;
    }
}
...
static async waitFor(locator, options = {}) {
    try {
        ...
        console.warn(`An error occurred while waiting for ${locator}, Error:`, error);
        throw error;
    }
}
...
static async waitForEvent(page, event, options = {}) {
    try {
        ...
        console.warn(`An error occurred while waiting for event ${event} on page, Error:`, error);
        throw error;
    }
}
...
static async newBrowserContext(browser) {
    try {
        ...
        console.warn(`An error occurred while creating a new browser context, Error:`, error);
        throw error;
    }
}
...
static async newPage(context) {
    try {
        ...
        console.warn(`An error occurred while creating a new page, Error:`, error);
        throw error;
    }
}
